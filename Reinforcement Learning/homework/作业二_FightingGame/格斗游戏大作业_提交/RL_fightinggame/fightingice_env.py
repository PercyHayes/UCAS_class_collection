...
# --------------------------------------------------------
# References:
# FightingGame-FTG4.50: https://github.com/RuoyuChen10/FightingGame-FTG4.50
# --------------------------------------------------------
...
class FightingiceEnv(gym.Env):
    ...
    def __init__(self, **kwargs):
        ...
        if "character" in kwargs.keys():
            ...
            self.character = 'ZEN'  # 控制角色，默认是ZEN
    ...
    def _start_gateway(self, p2="MctsAi"):
        ...
        # self.game_to_start = self.manager.createGame( "GARNET",self.character,
