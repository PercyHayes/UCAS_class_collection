...
class DDIMSampler(object):
    def __init__(self, model, schedule="linear", device=torch.device("mlu"), **kwargs):
        super().__init__()
        self.model = model
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="uniform", ddim_eta=0.,erbose=True):
        ...
        self.register_buffer('sqrt_alphas_cumprod', to_torch(______________________________))
