...
class MaxPoolingLayer(object):
    ...
    def forward(self, input):
        ...
        height_out = (self.input.shape[2] - self.kernel_size) // self.stride + 1 #__________________________________
        width_out = (self.input.shape[3] - self.kernel_size) // self.stride + 1 #________________________________
